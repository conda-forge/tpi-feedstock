...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tpi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13901&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tpi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tpi` can be installed with:

```
conda install tpi
```

It is possible to list all of the versions of `tpi` available on your platform with:
